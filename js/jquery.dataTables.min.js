...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primeiro",sLast:"Último",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Não foi encontrado nenhum dado.",sInfo:"Mostrar _START_ em _END_ de _TOTAL_ registos",sInfoEmpty:"Mostrar 0 em 0 de 0 registos",sInfoFiltered:"(filtro total de _MAX_ registos)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ registos",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"<i class='fa fa-search'></i> Procurar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Não foram encontrados registos"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
